#!/usr/bin/env sh
# Universal installer for trackblock. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/trackblock.git"
echo "Installing trackblock ..."
